...
public class CreatureGenerator {
    ...
    private static SceneObject generateQuadruped(String rootId, String name, String species, MaterialManager matMgr) {
        ...
        neck.getTransform().setPosition(0f, 0.22f, 0.2f);
        chest.addChild(neck);
        ...
        flUpper.getTransform().setPosition(-flX, -0.15f, 0.15f);
        ...
        SceneObject frUpper = new SceneObject(rootId + "_fr_up", "Front Right Upper Leg", "CREATURE",
                PrimitiveGenerator.createCylinder(0.07f, flLegLen, 8), skinMat);
        frUpper.getTransform().setPosition(flX, -0.15f, 0.15f);
        ...
        rlUpper.getTransform().setPosition(-rlX, -0.15f, -0.1f);
        ...
        SceneObject rrUpper = new SceneObject(rootId + "_rr_up", "Rear Right Upper Leg", "CREATURE",
                PrimitiveGenerator.createCylinder(0.08f, rlLegLen, 8), skinMat);
        rrUpper.getTransform().setPosition(rlX, -0.15f, -0.1f);
        ...
        tail.getTransform().setPosition(0f, 0.1f, -0.22f);
        tail.getTransform().setRotation(-30f, 0f, 0f); // Downward sloped tail
    ...
    private static SceneObject generateBird(String rootId, String name, MaterialManager matMgr) {
        Material skinMat = matMgr.getMaterial("mat_foliage"); // Green feather placeholder
        Material beakMat = matMgr.getMaterial("mat_metallic_gold");

        // 1. Root Spine Body Node
        ...
        neck.getTransform().setPosition(0f, 0.15f, 0.15f);
        spine.addChild(neck);

        SceneObject head = new SceneObject(rootId + "_head", "Head", "CREATURE",
                PrimitiveGenerator.createSphere(0.1f, 10, 10), skinMat);
        head.getTransform().setPosition(0f, 0.15f, 0.08f);
        neck.addChild(head);

        // Beak
        SceneObject beak = new SceneObject(rootId + "_beak", "Beak", "CREATURE",
                PrimitiveGenerator.createCylinder(0.03f, 0.12f, 4), beakMat);
        beak.getTransform().setPosition(0f, 0f, 0.08f);
        beak.getTransform().setRotation(90f, 0f, 0f); // Forward facing beak
        head.addChild(beak);
        ...
        lWingArm.getTransform().setRotation(0f, 0f, 15f); // Angled upward
        ...
        rWingArm.getTransform().setRotation(0f, 0f, -15f);
        ...
        tail.getTransform().setRotation(-10f, 0f, 0f);
        spine.addChild(tail);
